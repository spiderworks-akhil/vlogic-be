                        ...
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row">
                                    <div class="col">
                                        @if($obj->id)
                                            <h4 class="page-title">Edit press Member</h4>
                                        @else
                                            <h4 class="page-title">Create new press Member</h4>
                                        @endif
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Admin</a></li>
                                            <li class="breadcrumb-item"><a href="{{ route($route.'.index') }}">All press Members</a></li>
                                            <li class="breadcrumb-item active">@if($obj->id)Edit @else Create new @endif press Member</li>
                                        </ol>
                                    </div><!--end col-->
