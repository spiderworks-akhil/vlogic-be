...
<fieldset>
    ...
    <fieldset>
        ...
        <div class="form-group col-md-12">
            ...
            <textarea name="content[banner_footer_description]" class="form-control" rows="4">@if($obj->content && isset($obj->content['banner_footer_description'])){{ $obj->content['banner_footer_description'] }}@endif</textarea>
        </div>
    </fieldset>
</div>
